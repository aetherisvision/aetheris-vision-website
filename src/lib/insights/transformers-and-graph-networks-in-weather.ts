...
- **Out-of-distribution weather is a live question.** The training archive contains a finite sample of climate. Events without precedent — and a background climate that drifts from the training record — probe the models exactly where learned statistics are weakest. Physical models generalize from equations; learned models generalize from history.
